...
Expected behavior: The request should be rejected with a 401 Unauthorized or 403 Forbidden.   Actual behavior: The request succeeded. The store with ID 123 was deleted from the database. The server never checked for  user authtoken | Images         | ![Burb successful call](BurbCall.png) <br/> Successful DELETE request with butchered token |
